...
public class Variant7<T1, T2, T3, T4, T5, T6, T7> extends VariantBase {
	...
	public <U1, U2, U3, U4, U5, U6, U7> Variant7<U1, U2, U3, U4, U5, U6, U7> map(
		...
		switch (getIndex()) {
			case 0: return Variant7.make1(func1.apply(get()));
			case 1: return Variant7.make2(func2.apply(get()));
			case 2: return Variant7.make3(func3.apply(get()));
			case 3: return Variant7.make4(func4.apply(get()));
			case 4: return Variant7.make5(func5.apply(get()));
			case 5: return Variant7.make6(func6.apply(get()));
			default: return Variant7.make7(func7.apply(get()));
		}
	}
